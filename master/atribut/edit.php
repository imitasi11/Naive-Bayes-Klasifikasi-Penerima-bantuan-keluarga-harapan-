...
$isi=array();
$id=$_GET['id'];
$sql = "SELECT * FROM tb_atribut where id_atribut = '$id'";
$result = $db->query($sql);
...
?>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Edit Atribut</strong>
  ...
  <?php
  $querydata_mysql = "SELECT * FROM tb_parameter WHERE id_atribut='$id' order by nilai";
  ...
  ?>
  <div align="center">
    <input style="margin-top: 30px;" type="submit" class="btn btn-primary" name="upload" value="Edit">
  </div>           
</div>
                        </div>
                    </div>
