            ...
            <div class="animated fadeIn">  
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 align="center">Penentuan Klasifikasi PKH</h3>
                                <div align="center" style="margin-top: 13px;"><img style="border:1px solid black;" src="images/a.jpg">
                                   <div style="width: 72%; margin-top: 7px;"> <p align="justify">Program Keluarga Harapan merupakan sebuah program bantual sosial<i>(bansos)</i> yang diluncurkan pemerintah Indonesia pada tahun 2007, program diperuntukan untuk keluarga miskin supaya dapat menikmati akses pendidikan, kesehatan dan kesejahteraan sosial untuk memutus rantai kemiskinan di indonesia</p></div></div>
           </div>
                        </div>
                    </div>
