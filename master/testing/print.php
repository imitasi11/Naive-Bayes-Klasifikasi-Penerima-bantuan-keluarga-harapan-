                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-table"></i><a href="../testing.php">Data Testing</a></li>
                            <li   class="active"><i class="menu-icon fa fa-book"></i><a href="../print.php">Print Data Testing</a></li>
                        </ul>
                    </li>
...
?>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Print Preview</strong>
                                <a class="btn btn-primary" onclick="printContent('div1')" href="#">Print</a>
                            </div>
                            <div class="card-body">
                                <div id="div1" style="height: 300px;" align="center"><div>
                                    <div align="center">
                                    <h3 align="left" ><img style="width: 90px; margin-left: 1%; float:left;position: absolute;" src="s.png" alt="logo">
                                    </h3>
                                    <b style="margin-top: 40px;">PEMERINTAH KABUPATEN SUKOHARJO<BR>KECAMATAN MOJOLABAN</b><BR>DESA PLUMBON
                                    <BR><b style="font-size: 15px;">Jl. P.Diponegoro No.07 Plumbon Telp. (0271) 661746 Kode Pos 57554</b></BR></div>
    ...
    border-top: solid 1px #aaa;"></b>
                                    <p align="left"> REKOMENDASI PENERIMA DANA PKH MENGGUNAKAN NAIVE BAYES</p>
                  ...
                  <tr>
                   ...
                   <tbody>
                        ...
                        foreach($data as $id_responden=>$dt_atribut){
                            echo "<tr><td style='text-align:center'>$nomor</td>
                            <td style='text-align:center'>{$responden[$id_responden]}</td>";
                            for($i=2;$i<=$jml_atribut;$i++){ 
                                echo "<td style='text-align:center'>{$parameter[$noatribut[$i]][$dt_atribut[$noatribut[$i]]]}</td>";
                            }
                            echo "<td style='text-align:center'>{$parameter[1][$dt_atribut[1]]}</td>";
                        ?>  </tr> <?php
                            $nomor=$nomor+1;
                            }
