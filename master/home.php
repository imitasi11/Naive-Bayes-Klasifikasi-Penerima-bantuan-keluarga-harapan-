                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Data Training</strong>
                                <div align="right">
                                <a href="training/input.php" class="btn btn-success">Tambah Data</a>
                              </div>
                            </div>
                            <div class="card-body">
                ...
                <thead>
                  <tr>
                   ...
                   <tbody>
                        ...
                        ?>  <td><a class="btn btn-primary" href="training/edit.php?id=<?php echo $id_responden; ?>">edit</a></td>
