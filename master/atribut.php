...
?>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Tabel Atribut</strong>
                                <div align="right">
                                <a href="atribut/input.php" class="btn btn-success">Tambah Atribut</a>
                              </div>
                            </div>
                            <div class="card-body">
                ...
                ?>
                    ...
                    <td align="center" style="text-align:center"><a class="btn btn-primary" href="atribut/edit.php?id=<?php echo $noatribut[$i]; ?>">edit</a></td>
                    <td align="center" style="text-align:center"><a class="btn btn-danger" href="atribut/hapus.php?id=<?php echo $noatribut[$i]; ?>">                delete</a></td>
                </tr>
                <?php
                }
                ?>
