...
$tsql = 'SELECT * FROM tb_parameter ORDER BY id_atribut,id_parameter';
...
foreach ($result as $row) {
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Edit Data Training</strong>
                            </div>
                            <div class="card-body">
  ...
  $ids = $_GET['id'];
  $query_mysql = "SELECT * FROM tb_responden WHERE id_responden='$ids'";
  ...
  ?>
      ...
      <?php
      $querydata_mysql = "SELECT * FROM tb_data WHERE id_responden='$ids' order by id_atribut";
        ...
        <?php echo $atribut[$data['id_atribut']];
          ...
          ?>
            <?php echo '<select class="form-control input-sm m-bot15" name="'.$ini.'">' ?>
              ...
              <?php
              if($atribut[$data['id_atribut']]=="Status"){
              ?>
    ...
    <div align="center" style="margin-top: 24px;">
      <input class="btn btn-primary" type="submit" name="upload" value="Edit"></div>      
