...
?>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Data Testing</strong>
                                <div align="right">
                                <button data-modal-target="#modalz" class="btn btn-success">Tambah Data Testing</button>
                                <a href="testing/print.php" class="btn btn-primary">Print Data Testing</a>
                              </div>
                            </div>
                            <div class="card-body">
                ...
                <thead>
                  <tr>
                   ...
                   <tbody>
                        ...
                        ?>  <td><a class="btn btn-primary" href="testing/edit.php?id=<?php echo $id_responden; ?>">edit</a></td>
                            <td><a class="btn btn-danger" href="testing/delete.php?id=<?php echo $id_responden; ?>">delete</a></td></tr> <?php
                            $nomor=$nomor+1;
                            }
    ...
    <div class="modalz" id="modalz">
    <div class="modal-header">
      <div class="title">Input Data Testing</div>
      <button data-close-button class="close-button">&times;</button>
    </div>
    <div class="modal-body">
      <form action="testing/input-aksi.php" method="post" enctype="multipart/form-data">    
      Nama <input type="text" name="nama" class="form-control">
      <div style="display: inline-block;">
      <?php
      for ($i=2; $i<=$jml_atribut ; $i++) { 
      ?>
      <div style="display:inline;width: 200px; float: left;margin-right: 42px;margin-top:  23px;">
      ...
      <div align="center">
      <input style="margin-top: 20px;"class="btn btn-primary" type="submit" name="upload" value="Tambah">
    </div>
  </form>
    </div>
  </div>
